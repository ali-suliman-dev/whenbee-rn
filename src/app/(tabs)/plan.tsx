...
//   Plan (today)  — the existing free Start-By flow (BuildView ↔ RunView).
...
// Focus curve/window detail lives in Patterns (FocusPatternsCard); task-packing
// is in the Phase-4 Timeline.
//
