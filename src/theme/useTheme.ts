...
export function resolveTheme(mode: ColorMode) {
  return { mode, colors: tokens.colors[mode], space: tokens.space, radii: tokens.radii,
    ...
    reveal: tokens.reveal, quizComb: tokens.quizComb, honeyGlyph: tokens.honeyGlyph, focusCurve: tokens.focusCurve, focusLadder: tokens.focusLadder, headerRing: tokens.headerRing, strip: tokens.strip,
