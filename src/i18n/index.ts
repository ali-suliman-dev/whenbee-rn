...
export const initI18n = async (): Promise<void> => {
  ...
  await i18n
    ...
    .init({
      ...
      defaultNS: 'common',
      ns: ['common', 'onboarding', 'paywall', 'settings', 'today', 'addTask', 'timer', 'notifications', 'patterns', 'voice', 'categoryDetail', 'review', 'routines', 'whenbee', 'planner', 'reward', 'calendar', 'shared', 'legal', 'categories'], // extend as namespaces are added.
