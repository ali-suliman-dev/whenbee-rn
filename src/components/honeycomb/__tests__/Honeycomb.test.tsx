...
describe('Honeycomb', () => {
  it('exposes a per-cell a11y label of "<label>, <pct>% calibrated, tier <tier>"', () => {
    render(
      <Honeycomb
        size="strip"
    ...
    expect(screen.getByLabelText('Cleaning, 78% calibrated, tier Getting closer')).toBeOnTheScreen();
  });
  ...
  it('rounds sharpness in the a11y label', () => {
    ...
    expect(screen.getByLabelText('Errands, 41% calibrated, tier Learning')).toBeOnTheScreen();
  });
